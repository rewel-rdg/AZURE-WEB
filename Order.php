...
$insert = "INSERT INTO [OrderDetails] ([Name],[Email],[Phone],[Address],[City],
    [State],[Country],[Pincode],[Category1],[Item1],[Quantity1],
    [Category2],[Item2],[Quantity2],[Category3],[Item3],[Quantity3]) 
        VALUES ('$name','$sender','$phone','$address','$city',
        '$state','$country','$pin','$category1','$item1','$quantity1',
        '$category2','$item2','$quantity2','$category3','$item3','$quantity3')";
...
try {
    ...
    $mail->Subject = 'Thank You For Order!';
    $mail->Body = "
